...
// handleConnectionChange dismisses a menu that cannot be trusted to redraw
// itself (see dismissTrayMenu) and hands it back once the connection settles.
// A transient state only takes it away: there is nothing worth reopening onto
// yet.
